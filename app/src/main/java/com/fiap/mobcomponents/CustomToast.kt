package com.fiap.mobcomponents
...
object CustomToast {
    ...
    fun success(activity: Activity, message: String) {
        showToast(
            ...
            ContextCompat.getDrawable(activity, R.drawable.ic_success_foreground),
            message
        )
    }
    ...
    fun warning(activity: Activity, message: String) {
        showToast(
            ...
            ContextCompat.getDrawable(activity, R.drawable.ic_warning_foreground),
            message
        )
    }
    ...
    fun error(activity: Activity, message: String) {
        showToast(
            ...
            ContextCompat.getDrawable(activity, R.drawable.ic_error_foreground),
            message
        )
    }
    ...
    fun info(activity: Activity, message: String) {
        showToast(
            ...
            ContextCompat.getDrawable(activity, R.drawable.ic_info_foreground),
            message
        )
    }
